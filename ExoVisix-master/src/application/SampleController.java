...
public class SampleController {
	...
	@FXML
	public Label warningOnlyNumber;
	@FXML
	public Label title;
	@FXML
...
//**********************************************************************************************
	...
	protected void saveFace() throws SQLException {
		...
		if (code.getText().trim().isEmpty() || fname.getText().trim().isEmpty() || lname.getText().trim().isEmpty() || age.getText().trim().isEmpty()) {
		...
		} else if (!code.getText().matches("[0-9]+") || !age.getText().matches("[0-9]+")) {

			new Thread(() -> {

				try {
					warningOnlyNumber.setVisible(true);

					//Thread.sleep(2000);
					Thread.sleep(2000);

					warningOnlyNumber.setVisible(false);
